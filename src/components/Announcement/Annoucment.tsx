    ...
    <div>
      ...
      <div className={styles.body}>
        <div className={styles.leftBlock}>
          <h1>Сдать в аренду на <br /> GrozRent несложно</h1>
        </div>
        <div className={styles.rightBlock}>
          <div className={styles.block}>
            <div className={styles.textBlock}>
              ...
              <br />
              <p>Поделитесь основными сведениями, например <br /> где вы находитесь</p>
            </div>
          ...
          <div className={styles.block}>
            <div className={styles.textBlock}>
              ...
              <br />
              <p>Добавьте как минимум 5 фотографий, название <br /> объявления и описание. Мы поможем.</p>
            </div>
          ...
          <div className={styles.block}>
            <div className={styles.textBlock}>
              ...
              <br />
              <p>Нужно установить начальную цену. Если готовы, можно публиковать объявление.</p>
            </div>
